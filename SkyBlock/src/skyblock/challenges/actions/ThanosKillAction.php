...
class ThanosKillAction extends ChallengeAction
{
    ...
    {
        return SkyblockChallengeSet::KILL_THANOS;
    }

    public function toDisplayString(): string
    {
        return TextFormat::YELLOW . 'Defeat Thanos ' . TextFormat::GOLD . $this->getGoal() . TextFormat::YELLOW . ' time(s)';
    }
}