...
class MineAction extends BlockBreakAction
{
    public function toDisplayString(): string
    {
        return TextFormat::YELLOW . 'Mine ' . TextFormat::GOLD . $this->getGoal() . TextFormat::YELLOW . ' blocks of ' . TextFormat::GOLD . $this->block->getName();
    }
}