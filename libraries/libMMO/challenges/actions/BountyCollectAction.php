...
class BountyCollectAction extends ChallengeAction
{
    /** @var string[][] */
    ...
    {
        return ChallengeSet::COLLECT_BOUNTY;
    }

    public function toDisplayString(): string
    {
        return TextFormat::YELLOW . 'Collect the bounty of ' . TextFormat::GOLD . $this->getGoal() . TextFormat::YELLOW . ' different players';
    }
}