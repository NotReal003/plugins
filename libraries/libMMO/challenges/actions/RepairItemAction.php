...
class RepairItemAction extends ChallengeAction
{

    public function toDisplayString(): string
    {
        return TextFormat::YELLOW . 'Repair ' . TextFormat::GOLD . $this->getGoal() . TextFormat::YELLOW . ' items';
    }
    ...
    {
        return ChallengeSet::REPAIR_ITEM;
    }
}